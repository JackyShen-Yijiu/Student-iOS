...
- (void)drawBackgroundWithRect:(CGRect)rect
{
    ...
    CGContextSaveGState(ctx);
    {
        ...
        UIBezierPath* roundedRect = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, rect.size.width, rect.size.height-1) cornerRadius:0];
        [roundedRect fill];
...
-(void)drawStripesInBounds:(CGRect)frame {
    ...
    //clip
	UIBezierPath *clipPath = [UIBezierPath bezierPathWithRoundedRect:frame cornerRadius:0];
    [clipPath addClip];
...
-(void)drawProgressWithBounds:(CGRect)frame {
	UIBezierPath *bounds = [UIBezierPath bezierPathWithRoundedRect:frame cornerRadius:0];
