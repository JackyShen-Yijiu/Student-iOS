...
- (void)startDownLoad {
    ...
    __weak SubjectFirstViewController *weakSelf = self;
...
- (void)dealSignUp:(UIButton *)sender {
    ...
    if ([AcountManager isLogin]) {
        ...
        NSString *finalString = [self.questiontesturl stringByAppendingString:appendString];
...
- (void)dealCoach:(UIButton *)sender{
    ...
    if ([AcountManager isLogin]) {
        NSString *appendString = [NSString stringWithFormat:@"?userid=%@",[AcountManager manager].userid];
        NSString *finalString = [self.questionlisturl stringByAppendingString:appendString];
...
- (void)dealCard:(UIButton *)sender{
    ...
    if (![AcountManager isLogin]) {
        ...
        NSString *appendString = [NSString stringWithFormat:@"?userid=%@",[AcountManager manager].userid];
        NSString *finalString = [self.questionerrorurl stringByAppendingString:appendString];
