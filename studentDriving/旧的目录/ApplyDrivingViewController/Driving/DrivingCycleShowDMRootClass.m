...
@interface DrivingCycleShowDMRootClass ()
@end
@implementation DrivingCycleShowDMRootClass
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(dictionary[@"data"] != nil && [dictionary[@"data"] isKindOfClass:[NSArray class]]){
		...
		for(NSDictionary * dataDictionary in dataDictionaries){
			DrivingCycleShowDMData * dataItem = [[DrivingCycleShowDMData alloc] initWithDictionary:dataDictionary];
