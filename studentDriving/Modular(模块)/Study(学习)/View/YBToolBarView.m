...
@interface YBToolBarView()

//执行点击事件的Block
@property (nonatomic, copy) YBToolBarViewBlock itemBlock;
 ...
 */
- (void)dvvSetItemSelectedBlock:(YBToolBarViewBlock)handle {
    _itemBlock = handle;
}
