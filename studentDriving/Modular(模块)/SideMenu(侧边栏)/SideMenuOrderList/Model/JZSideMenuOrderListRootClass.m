//
//	JZSideMenuOrderListRootClass.m
//
...
#import "JZSideMenuOrderListRootClass.h"

@interface JZSideMenuOrderListRootClass ()
@end
@implementation JZSideMenuOrderListRootClass
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(dictionary[@"data"] != nil && [dictionary[@"data"] isKindOfClass:[NSArray class]]){
		...
		for(NSDictionary * dataDictionary in dataDictionaries){
			JZSideMenuOrderListData * dataItem = [[JZSideMenuOrderListData alloc] initWithDictionary:dataDictionary];
...
-(NSDictionary *)toDictionary
{
	...
	if(self.data != nil){
		...
		for(JZSideMenuOrderListData * dataElement in self.data){
