...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 35, self.view.frame.size.width, self.view.frame.size.height - 110) collectionViewLayout:flowLayout];
        // 注册Cell
...
- (void)clickRightBtn:(UIButton *)sender {
    ...
    [_collectionView registerClass:[YBDiscountCell class] forCellWithReuseIdentifier:kMallID];
    [UIView animateWithDuration:0.5 animations:^{
