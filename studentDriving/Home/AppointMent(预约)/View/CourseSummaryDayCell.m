...
- (void)initUI
{
    ...
    self.mainTitle.textColor = RGBColor(0x33, 0x33, 0x33);
    ...
    self.yiyueLabel.textColor = RGBColor(0x99, 0x99, 0x99);
    ...
    self.shengyuLabel.textColor = RGBColor(0x99, 0x99, 0x99);
    ...
    self.loukeLabel.textColor = RGBColor(0x99, 0x99, 0x99);
    ...
    self.courseBeginTime.textColor = RGBColor(30, 31, 34);
